...
use English\Http\Requests\Admin\CrazyCourseCreateRequest;
use English\Http\Requests\Admin\CrazyCourseUpdateRequest;
use English\Http\Resources\Admin\CrazyCourseResource;
use English\Http\Resources\Admin\CrazyCourseResourceCollection;
use English\Http\Services\Admin\CrazyCourseService;
use Illuminate\Http\Request;
use Symfony\Component\HttpKernel\Exception\HttpException;

class CrazyCourseAdminController extends Controller
{
    private $service;
