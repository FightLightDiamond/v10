...
use English\Http\Requests\Admin\RemindCreateRequest;
use English\Http\Requests\Admin\RemindUpdateRequest;
use English\Http\Resources\Admin\RemindResource;
use English\Http\Resources\Admin\RemindResourceCollection;
use English\Http\Services\Admin\RemindService;
use Illuminate\Http\Request;
use Symfony\Component\HttpKernel\Exception\HttpException;

class RemindAdminController extends Controller
{
    private $service;
