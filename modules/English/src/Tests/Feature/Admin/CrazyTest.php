...
class CrazyTest extends TestCase
{
    ...
    public function testStore()
    {
        ...
        $response = $this->post(route('admin.crazies.store'), $params, $this->getHeader());
    ...
    {
        $response = $this->get(route('admin.crazies.show', $this->getId()), $this->getHeader());
    ...
    {
        $params = [ 'name' => rand(1, 9), 'audio' => rand(1, 9), 'created_by' => rand(1, 9), 'updated_by' => rand(1, 9), 'is_active' => rand(1, 9), 'crazy_course_id' => rand(1, 9), 'img' => rand(1, 9), 'description' => rand(1, 9),  ];
        $response = $this->put(route('admin.crazies.update', $this->getId()), $params, $this->getHeader());
    ...
    {
        $response = $this->delete(route('admin.crazies.destroy', $this->getId()), [], $this->getHeader());
