...
class CrazyWriteHistoryTest extends TestCase
{
    ...
    public function testIndex()
    {
		...
		$response = $this->call('GET', route('api.crazy-write-histories.index'), $params, [], [], $server);
    ...
    public function testStore()
    {
        ...
        $response = $this->post(route('api.crazy-write-histories.store'), $params, $this->getHeader());
    ...
    {
        $response = $this->get(route('api.crazy-write-histories.show', $this->getId()), $this->getHeader());
    ...
    {
        $params = [ 'user_id' => rand(1, 9), 'crazy_id' => rand(1, 9), 'score' => rand(1, 9), 'type' => rand(1, 9),  ];
        $response = $this->put(route('api.crazy-write-histories.update', $this->getId()), $params, $this->getHeader());
    ...
    {
        $response = $this->delete(route('api.crazy-write-histories.destroy', $this->getId()), [], $this->getHeader());
