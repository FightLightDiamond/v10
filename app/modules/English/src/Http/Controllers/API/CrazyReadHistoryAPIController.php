...
use English\Http\Requests\API\CrazyReadHistoryCreateRequest;
use English\Http\Requests\API\CrazyReadHistoryUpdateRequest;
use English\Http\Resources\API\CrazyReadHistoryResource;
use English\Http\Resources\API\CrazyReadHistoryResourceCollection;
use English\Http\Services\API\CrazyReadHistoryService;
use Illuminate\Http\Request;
use Symfony\Component\HttpKernel\Exception\HttpException;

class CrazyReadHistoryAPIController extends Controller
{
    private $service;
...
//            return $data;
            return response()->json( new CrazyReadHistoryResourceCollection($data));
