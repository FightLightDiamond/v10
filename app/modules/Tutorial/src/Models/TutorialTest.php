...
class TutorialTest extends Model implements Transformable
{
    use TransformableTrait;
    use ModelsTrait;

    public $table = 'tutorial_tests';
    public $fillable = ['tutorial_id', 'question', 'reply1', 'reply2', 'reply3', 'reply4', 'answer', 'is_active', 'created_by', 'updated_by'];
    ...
    protected $pathUpload = ['image' => '/images/tutorial_tests'];
