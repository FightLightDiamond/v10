...
class SectionTest extends TestCase
{
    ...
    public function testStore()
    {
        ...
        $response = $this->post(route('admin.sections.store'), $params, $this->getHeader());
    ...
    {
        $response = $this->get(route('admin.sections.show', $this->getId()), $this->getHeader());
    ...
    {
        $params = [ 'name' => rand(1, 9), 'img' => rand(1, 9), 'is_active' => rand(1, 9), 'description' => rand(1, 9), 'tutorial_id' => rand(1, 9), 'no' => rand(1, 9),  ];
        $response = $this->put(route('admin.sections.update', $this->getId()), $params, $this->getHeader());
    ...
    {
        $response = $this->delete(route('admin.sections.destroy', $this->getId()), [], $this->getHeader());
